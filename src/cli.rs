...
pub const NO_MINIFY_HTML_HELP: &str =
    "Disable HTML minification (minification is enabled by default when saving HTML).";
...
pub struct Cli {
    ...
    #[arg(long, help = NO_MINIFY_HTML_HELP)]
    pub no_minify_html: bool,
