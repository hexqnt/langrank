...
LangRank — утилита на Rust, которая собирает свежие рейтинги популярности языков программирования (TIOBE, PYPL), объединяет их с данными Benchmarks Game и вычисляет итоговое ранжирование по методу Шульце.
...
1. Подтягивает сводки рейтингов TIOBE и PYPL.
